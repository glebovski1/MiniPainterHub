...
> Reason: superseded implementation plan with durable decisions extracted into an ADR; superseded by [[30 Process/Decisions/2026-04-19-admin-moderation-roles-audit]].
...
> Path convention note: this plan originally lived under the legacy design docs tree; it now lives in the Obsidian vault under `40 Design`.
...
- **Layering**: controllers are transport/orchestration; business rules belong in `MiniPainterHub.Server/Services` (`AGENT.md`, [ARCHITECTURE.md](<../../../../20 Engineering/ARCHITECTURE.md>), current controller/service code).
