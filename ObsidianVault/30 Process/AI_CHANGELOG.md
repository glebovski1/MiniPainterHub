...
Status: legacy historical index. New vault maintenance entries should be written under `_logs/vault-changes/`; this file is retained only for pre-log AI-assisted change history.
