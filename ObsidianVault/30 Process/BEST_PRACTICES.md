...
When code behavior changes, update the matching vault note in `ObsidianVault/` during the same change. Use [Agent Navigation.md](<../00 Start Here/Agent Navigation.md>) for routing.
